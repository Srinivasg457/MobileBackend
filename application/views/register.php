<section class="section p-0 mt--50 d-block">
  <div class="container">
      ...
      <div class="row">
        <div class="col-md-8 mx-auto text-center">
          <a class="site-logo" href="<?php echo base_url() ?>">
            <img class="img-fluid" width="50%" src="<?php echo base_url($settings->logo) ?>" alt="demo" />
          </a>
          <h3 class="mb-0"><?php echo html_escape($settings->site_title) ?></h3>
          <h5 class="mt-2"><?php echo html_escape($settings->site_name) ?><span> <?php echo trans('register-info') ?></span></h5>
        </div>
      </div>
      ...
      <div class="account_area row justify-content-md-center mt-0">
        ...
        <div class="col-md-6 col-lg-6 col-sm-12 text-left" data-aos="fade-right">
          ...
          <form id="register_form" class="authorizationform authorizationform--shadow leave_con" method="post" action="<?php echo base_url('register_user'); ?>">
            ...
            <div class="input-wrp">
              <input class="textfield textfield--grey" maxlength="10" type="text" name="phone" placeholder="<?php echo trans('phone') ?>" required />
            </div>

            <div class="input-wrp" style="position: relative;">
              <input class="textfield textfield--grey" type="password" name="password" id="password" placeholder="<?php echo trans('password') ?>" required style="padding-right: 40px;" />
              <i class="fas fa-eye-slash toggle-password"
                style="position: absolute;top: 15px;right: 12px; cursor: pointer;color: #aaa;font-size: 18px;line-height: 1;height: 18px;width: 18px;text-align: center;">
              </i>
            </div>
            ...
            <p>
              <label class="checkbox mt-0">
                ...
                <i class="fontello-check"></i><span><?php echo trans('i-agree-with-the') ?> <a target="_blank" href="<?php echo base_url('terms-of-service') ?>"><?php echo trans('terms-of-service') ?></a></span>
              </label>
            </p>
            ...
            <div class="text-center">
              <button class="btn btn-primary btn-block submit_btn mb-4 loader_btn" type="submit"><?php echo trans('get-started') ?> </button>
              <a class="create" href="<?php echo base_url('login'); ?>">Already have an account? Log In</a>
            </div>
                      ...
                      foreach ($packages as $package): ?>
                        <td class="p-0">
                          <div class="theader <?php if ($a == 2) {
                            ...
                            <div class="price mb-5 <?php if ($a == 2) {
                                                      echo "colm_2";
                                                    } ?>">
