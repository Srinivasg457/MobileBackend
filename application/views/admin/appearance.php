                ...
                <div class="box-body p-10">
                    ...
                    <div class="row p-30 mb-0">
                        ...
                        <div class="form-group col-12">
                            ...
                            <input type="text" class="form-control colorpicker d-block" name="site_color" value="<?php echo $settings->site_color; ?>" style="border: 4px solid #<?php echo $settings->site_color; ?>; padding-left: 10px;">
                        </div>
