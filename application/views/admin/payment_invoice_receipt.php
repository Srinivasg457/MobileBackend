...
<body>
    ...
    <div class="main-box">
        ...
        <?php if (isset($page_title) && $page_title != 'Export'): ?>
            <!-- <a href="<?php //echo base_url('render/export_invoice/'.$user->puid) 
                            ?>" class="btn btn-default btn-rounded mr-5 mb-20"><i class="fa fa-download"></i> <?php //echo trans('download-pdf') 
                                                                                                                                                                        ?> </a> -->
            <a href="<?php echo base_url('admin/payment/lists') ?>" class="pull-right btn btn-secondary btn-sm"><i class="fa fa-angle-left"></i> <?php echo trans('back') ?></a>

            <a href="<?php echo base_url('render/export_invoice/' . $user->puid) ?>" data-id="invoice_<?php echo rand() ?>" class="btn btn-default btn-rounded mr-5 mb-20"><i class="fa fa-download"></i> <?php echo trans('download-pdf') ?> </a>
        <?php endif ?>

        <div class="invoice-box print_area p-0 <?php if (isset($page_title) && $page_title != 'Export') {
                                                    echo "br1 shadow-lg";
                                                } ?>">
