  ...
  <section class="content">
    ...
    <?php if (isset($page_title) && $page_title != "Edit"): ?>
      ...
      <div class="list_area container">
        ...
        <?php else: ?>
          <h3 class="box-title">
            <?php echo trans('all-customers') ?> <a href="#" class="pull-right btn btn-info rounded btn-sm add_btn"><i class="fa fa-plus"></i> <?php echo trans('add-new-customer') ?></a>
            <a href="<?php echo base_url('admin/file/import/' . 'customers') ?>" class="pull-right btn btn-info rounded btn-sm mx-5"><?php echo trans('import-customers') ?></a>
          </h3>
        <?php endif; ?>
