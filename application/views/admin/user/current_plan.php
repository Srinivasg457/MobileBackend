                        ...
                        <div class="box add_area">
                            <div class="box-header flex-between">
                                ...
                                <div>
                                    ...
                                    <a href="<?php echo base_url('admin/subscription') ?>" class="pull-right btn btn-info btn-xs  mr-4"><i class="fa fa-diamond" aria-hidden="true"></i> <?php echo trans('upgrade-plan') ?></a>
                                </div>  
                            </div>
                        ...
                        <div class="box add_area">
                            <div class="box-header flex-between">
                                ...
                                <div>
                                    ...
                                    <a href="<?php echo base_url('admin/subscription') ?>" class="pull-right btn btn-info btn-xs mt-1 mr-4"><i class="fa fa-diamond" aria-hidden="true"></i> <?php echo trans('upgrade-plan') ?></a>
                                </div>
