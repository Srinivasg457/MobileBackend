                                    ...
                                    <div class="col-xs-6 col-md-8 text-right">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <?php else: ?>
                                                    <input type="text" class="form-control" name="number" value="<?php echo get_auto_invoice_number(user()->id, 2, 0, 0)?>">
                                                <?php endif ?>
                                            </div>
                                        </div>
                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr class="item-row">
                                                ...
                                                <?php if ($this->business->enable_unit==1): ?>
                                        ...
                                        <?php if (isset($page_title) && $page_title == 'Edit Estimate'): ?>
                                            ...
                                            <?php foreach ($items as $product): ?>
                                                <tr class="item-row">
                                                    ...
                                                    <td width="10%">
                                                            <select class="form-control units_off" name="units[]">
                                                                <?php foreach (get_units() as $unit): ?>
                                                                <option value="<?php echo $unit ?>" <?php if($product->type == $unit){echo "selected";} ?>><?php echo $unit ?>
                                                                <?php endforeach ?>
                                                            </select>
                                                        </td>
                                                    <td width="15%">
