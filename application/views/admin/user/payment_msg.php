            ...
            <div class="col-md-12">
                <div class="pay-box pt-200">
                    <?php if (isset($success_msg) && $success_msg=='Success'): ?>
                        ...
                        <a href="<?php echo base_url('admin/subscription/upgrade_plan') ?>" class="btn btn-md btn-info"><?php echo trans('continue') ?></a>
                    <?php endif; ?>
                    <?php if (isset($error_msg) && $error_msg=='Error'): ?>
                        ...
                        <a href="<?php echo base_url('admin/subscription/upgrade_plan') ?>" class="btn btn-md btn-default"><?php echo trans('try-again') ?></a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
