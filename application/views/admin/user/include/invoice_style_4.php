                        ...
                        <?php else: ?>
                            <?php for ($i=0; $i < $total_items; $i++) { ?>
                                <tr class="inv-pl30">
                                    ...
                                    <td class="pl-30"><?php echo price_formatted_alt($this->session->userdata('price')[$i], $business_id, $currency_symbol) ?></td>
                                    <td class="pl-30"><?php echo $this->session->userdata('quantity')[$i] ?>
                                        
                                        <?php if ($unit_status == 1): ?>
                                            <?php echo $this->session->userdata('unit')[$i] ?>
                                        <?php endif; ?>
                        ...
                        <?php else: ?>
                            <?php foreach ($items as $item): ?>
                                <tr class="inv-pl30">
                                    ...
                                    <td class="pl-30">
                                        <?php echo html_escape($item->qty) ?> 

                                        <?php if ($unit_status == 1): ?>
                                            <?php echo html_escape($item->type) ?>
                                        <?php endif; ?>
                                    </td>
