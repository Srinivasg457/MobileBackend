<ul class="nav nav-tabs admin mb-4">
  ...
  <?php if (auth('role') == 'user' || auth('role') == 'subadmin'): ?>
	  ...
	  <!-- <?php if (settings()->global_twilio == 0): ?>
		  <li><a class="<?php if(isset($page_title) && $page_title == 'Twilio Sms'){echo "active";} ?>" href="<?php echo base_url('admin/profile/twilio_settings') ?>"><i class="fa fa-envelope"></i> <span class="hidden-xs"><?php echo trans('twilio-sms-settings') ?></span></a></li>
		<?php endif; ?>
  <?php endif; ?> -->
