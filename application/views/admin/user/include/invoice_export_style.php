    ...
    <div class="row p-30" style="width: 100%">
        ...
        <div class="col-6 text-right" style="width: 45%; float: right; margin-top: -10px">
            ...
            <p class="font-weight-bold mb-0">
                <!-- <?php //echo html_escape($title) ?> <br> --> <?php echo html_escape($summary) ?> 
            </p>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        ...
                        <?php else: ?>
                            <?php foreach ($items as $item): ?>
                                <tr class="inv-pl30">
                                    <td style="padding-left: 30px" width="40%"><?php echo html_escape($item->item_name) ?> <br> <small><?php echo nl2br($item->details) ?></small></td>
                                    <td style="padding-left: 30px" ><?php echo price_formatted_alt($item->price, $business_id, $currency_symbol) ?></td>
                                    <td style="padding-left: 30px"><?php echo html_escape($item->qty) ?> <?php echo html_escape($item->type) ?></td>
                                    <td style="padding-left: 30px"><?php echo price_formatted_alt($item->total, $business_id, $currency_symbol) ?></td>
                                </tr>
                            <?php endforeach ?>
                        <?php endif ?>
                    <?php endif ?>
                    ...
                    <tr class="inv-pl30">
                        ...
                        <td style="padding-left: 30px"><span><?php echo price_formatted_alt($sub_total, $business_id, $currency_symbol) ?></span></td>
                    </tr>
                        ...
                        <?php foreach ($taxes as $tax): ?>
                            <?php if ($tax != 0): ?>
                               <tr class="inv-pl30">
                                    ...
                                    <td style="padding-left: 30px"><span><?php echo price_formatted_alt($sub_total * (get_tax_id($tax)->rate / 100), $business_id, $currency_symbol) ?></span></td>
                                </tr>
                            <?php endif ?>
                        <?php endforeach ?>
                    <?php endif ?>
                    ...
                    <?php if (!empty($discount)): ?>
                        <tr class="inv-pl30">
                            ...
                            <td style="padding-left: 30px"><span><?php echo price_formatted_alt($sub_total * ($discount / 100), $business_id, $currency_symbol) ?></span></td>
                        </tr>
                    <?php endif ?>
                    <tr class="inv-pl30">
                        <td></td>
                        ...
                        <td style="padding-left: 30px"><span><?php echo price_formatted_alt($grand_total,$business_id, $currency_symbol) ?></span></td>
                    </tr>
                    ...
                    <tr class="inv-pl30">
                        ...
                        <td class="bg-mlight" style="padding-left: 30px">
                            <span>
                                <?php if ($status == 2): ?>
