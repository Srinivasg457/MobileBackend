    ...
    overflow-y: auto;
        ...
        <div class="container">
            ...
            <div class="search-row">
                Employee: <input type="text" id="search-name" class="form-control" placeholder="Search Users / Department">
                ...
                try {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            $('#datePicker').val(response.metadata.date);
    ...
    <div class="screenshot-card" style="width: 200px; margin: 5px;">
        ...
        <div style="margin-top:10px; display: flex; align-items: center; justify-content: space-between; font-size: 12px;">
            ...
            />
                                ...
                                container.html("<p>No webcam screenshots available.</p>");
