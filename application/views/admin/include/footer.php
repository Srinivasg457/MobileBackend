...
<input type="hidden" id="success" value="<?php if(!empty($success)){echo html_escape($success);} ?>">
<input type="hidden" id="error" value="<?php if(!empty($error)){echo html_escape($error);} ?>">
...
<input type="hidden" id="unit_status" value="<?php if(!empty($this->business)) {echo $this->business->enable_unit;}else{echo "0";}; ?>">
<?php $u=1; foreach (get_units() as $unit): ?>
