      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php if (is_admin()): ?>
          ...
          <li class="treeview <?php if(isset($page) && $page == "Blog"){echo "active";} ?>">
            ...
            <ul class="treeview-menu">
              <li class="<?php if(isset($page_title) && $page_title == "Blog Category"){echo "active";} ?>"><a href="<?php echo base_url('admin/blog_category') ?>"><i class="bi bi-arrow-right"></i><?php echo trans('add-category') ?> </a></li>
              <li class="<?php if(isset($page_title) && $page_title == "Blog Posts"){echo "active";} ?>"><a href="<?php echo base_url('admin/blog') ?>"><i class="bi bi-arrow-right"></i><?php echo trans('blog-posts') ?></a></li>
            </ul>
          </li> 
