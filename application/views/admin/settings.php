      ...
      <form method="post" enctype="multipart/form-data" action="<?php echo base_url('admin/settings/update') ?>" role="form" class="form-horizontal">
        ...
        <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs admin">
              ...
              <li><a href="#sms_settings" data-toggle="tab"><i class="fa fa-envelope"></i> <span class="hidden-xs"><?php echo trans('twilio-sms-settings') ?></span></a></li>
            ...
            <div class="row mt-20">
              <div class="col-md-8">
                <div class="tab-content box">
                              ...
                              <div class="form-group">
                                  <div class="col-sm-12">
                                      ...
                                      <div style="position:relative;" class="m-t-5">
                                          ...
                                          &nbsp;
                                          <span class='label label-light text-dark' id="upload-hero"></span>
                                      </div>
                                  </div>
                              </div>
                            </div>
                              ...
                              <div class="form-group">
                                  <div class="col-sm-12">
                                      ...
                                      <div style="position:relative;" class="m-t-5">
                                          ...
                                          &nbsp;
                                          <span class='label label-light text-dark' id="upload-favicon"></span>
                                      </div>
                                  </div>
                              </div>
                            </div>
                              ...
                              <div class="form-group">
                                  <div class="col-sm-12">
                                      ...
                                      <div style="position:relative;" class="m-t-5">
                                          ...
                                          &nbsp;
                                          <span class='label label-light text-dark' id="upload-logo"></span>
                                      </div>
                                  </div>
                              </div>
                            </div>
                    ...
                    <div class="tab-pane" id="sms_settings" aria-hidden="false">
                      <div class="box-body">

                        <div class="form-group flex-parent-between">
                          <label class="mt-5"><?php echo trans('enable-globally') ?> 
                            <br><small class="fs-13 text-muted"> <?php echo trans('enable-globally-twilio') ?> </small>
                          </label>
                          <div class="switch">
                            <input type="checkbox" name="global_twilio" value="1" <?php if($settings->global_twilio == 1){echo "checked";} ?> data-toggle="toggle" data-onstyle="info" data-width="100"> 
                          </div>
                        </div>
