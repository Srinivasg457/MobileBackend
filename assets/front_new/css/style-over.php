...
.overlay:after {
    ...
    top: 0;
    bottom: 0;
    background: rgba(<?= $_GET['rgb'] ?>,0.6) !important;
    opacity: 1 !important;
    z-index: 0;
}

.overlay.overlay-primary.alpha-4:after {
  background: rgba(<?= $_GET['rgb'] ?>,0.5) !important;
}
...
.border-1{
    border: 1px solid rgba(<?= $_GET['rgb'] ?>,.3) !important;
}

.border-2{
    border: 2px solid rgba(<?= $_GET['rgb'] ?>,.3) !important;
}

.bg-soft1{
    background: rgba(<?= $_GET['rgb'] ?>,.01) !important;
}

.bg-soft2{
    background: rgba(<?= $_GET['rgb'] ?>,.02) !important;
}

.bg-soft3{
    background: rgba(<?= $_GET['rgb'] ?>,.03) !important;
}
...
.link:hover{
    color: rgba(<?= $_GET['rgb'] ?>, 3) !important;
...
.cdropdown-content a:hover {
    background-color: rgba(<?= $_GET['rgb'] ?>,.09);;
    color: #<?= $_GET['color'] ?> !important;
    border-radius: 6px;
}
