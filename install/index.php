...
if (phpversion() <= 7.2) {
    die('<div style="background: rgba(220,53,69,.1); padding: 50px; margin:300px 0px; color: red; font-size: 20px; font-family: Arial"> You are using phpversion:<b>'.phpversion().'</b>, Please set your phpversion <b>7.4 or higher </b>from your server to continue the installation.</div>');
}
