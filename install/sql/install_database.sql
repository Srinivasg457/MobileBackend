...
--
-- Host: localhost:8889
-- Generation Time: Aug 10, 2024 at 09:23 AM
...
CREATE TABLE `business` (
  ...
  `enable_unit` varchar(155) DEFAULT '0',
  `units` longtext,
...
(1, 2, 18276373, 'Alex', 'a@mail.com', 'w3r', NULL, NULL, 29, 'CHF', NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL);
...
(1, 2, 18276373, '', 1, 0, NULL, '', '2024-1', '', 1, '2024-08-10', 0, '2024-08-10', NULL, 1, '', '20.00', '20.00', '18.67', 1, 'uploads/files/qrcode_11138501651.png', NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, 0, NULL, '2024-08-10 09:25:35');
...
(1, 1, 1, 'Tewrsdfasdf', '1', '20.00', '20.00', NULL);
...
(837, 'user', 'Unit', 'unit', 'Unit'),
(838, 'user', 'Units', 'units', 'Units'),
(839, 'user', 'Enable Unit', 'enable-unit', 'Enable Unit'),
(840, 'user', 'Enable this feature you will be able to manage your products unit in invoices.', 'enable-unit-help', 'Enable this feature you will be able to manage your products unit in invoices.'),
(841, 'user', 'Clone', 'clone', 'Clone'),
(842, 'user', 'has been seen', 'has-been-seen', 'has been seen'),
(843, 'user', 'just received an anonymous view', 'just-received-an-anonymous-view', 'just received an anonymous view'),
(844, 'user', 'Workflows', 'workflows', 'Workflows'),
(845, 'user', 'Add new workflow', 'add-new-workflow', 'Add new workflow'),
(846, 'user', 'Edit Workflow', 'edit-workflow', 'Edit Workflow'),
(847, 'user', 'What our awesome community is talking about', 'blog-title', 'What our awesome community is talking about'),
(848, 'user', 'Company', 'company', 'Company'),
(849, 'user', 'Product', 'product', 'Product'),
(850, 'user', 'Log in to', 'log-in-to', 'Log in to'),
(851, 'user', 'Dont have an account yet?', 'dont-have-an-account-yet', 'Dont have an account yet?'),
(852, 'user', 'Welcome to ', 'welcome-to', 'Welcome to '),
(853, 'user', 'Log in to your account', 'log-in-to-your-account', 'Log in to your account'),
(854, 'user', 'Forgot', 'forgot', 'Forgot'),
(855, 'user', 'Weve got you covered', 'weve-got-you-covered', 'We have got you covered'),
(856, 'user', 'Enter your email bellow to retrieve your account or', 'enter-your-email-bellow-to-retrieve-your-account-or', 'Enter your email bellow to retrieve your account or'),
(857, 'user', 'Your registered email', 'your-registered-email', 'Your registered email'),
(858, 'user', 'Pricing Plans', 'pricing-plans', 'Pricing Plans'),
(859, 'user', 'Try It Free', 'try-it-free', 'Try It Free'),
(860, 'user', 'If you still have any question contact with us.', 'if-you-still-have-any-question-contact-with-us', 'If you still have any question contact with us.'),
(861, 'user', 'Do you have', 'do-you-have', 'Do you have'),
(862, 'user', 'questions?', 'questions', 'questions?'),
(863, 'user', 'Try', 'try', 'Try'),
(864, 'user', 'free for 15 days!', 'free-for-15-days', 'free for 15 days!'),
(865, 'user', 'Ready to get started?', 'ready-to-get-started', 'Ready to get started?'),
(866, 'user', 'Here are the answers to some of the most common questions we hear from our appreciated customers.', 'faq-page-title', 'Here are the answers to some of the most common questions we hear from our appreciated customers.'),
(867, 'user', 'Common Questions', 'common-questions', 'Common Questions'),
(868, 'user', 'Contact us', 'contact-us', 'Contact us'),
(869, 'user', 'Get in touch and let us know how we can help. Fill out the form and we’ll be in touch as soon as possible.', 'contact-title', 'Get in touch and let us know how we can help. Fill out the form and we’ll be in touch as soon as possible.'),
(870, 'user', 'Thank you!', 'thank-you', 'Thank you!'),
(871, 'user', 'Your message has been send, we will contact you as soon as possible.', 'your-message-has-been-send-we-will-contact-you-as-soon-as-possible', 'Your message has been send, we will contact you as soon as possible.'),
(872, 'user', 'Log In', 'log-in', 'Log In'),
(873, 'user', 'free-for-', 'free-for-', 'free for'),
(874, 'user', 'Payment gateways are only available with Extended License', 'payment-gateways-are-only-available-with-extended-license', 'Payment gateways are only available with Extended License'),
(875, 'user', 'Sandbox', 'sandbox', 'Sandbox'),
(876, 'user', 'Live', 'live', 'Live'),
(877, 'user', 'Stripe', 'stripe', 'Stripe'),
(878, 'user', 'Mercado Pogo', 'mercado-pogo', 'Mercado Pogo'),
(879, 'user', 'Public key', 'public-key', 'Public key'),
(880, 'user', 'Access Token', 'access-token', 'Access Token'),
(881, 'user', 'Twilio SMS Settings', 'twilio-sms-settings', 'Twilio SMS Settings'),
(882, 'user', 'Enable Globally', 'enable-globally', 'Enable Globally'),
(883, 'user', 'Enable to activate Twilio sms for admin and user side.', 'enable-globally-twilio', 'Enable to activate Twilio sms for admin and user side.'),
(884, 'user', 'Account SID', 'account-sid', 'Account SID'),
(885, 'user', 'Auth Token', 'auth-token', 'Auth Token'),
(886, 'user', 'Sender Number (Twillo)', 'sender-number-tw', 'Sender Number (Twillo)'),
(887, 'user', 'Enable Booking Confirmation SMS', 'enable-booking-confirmation-sms', 'Enable Booking Confirmation SMS'),
(888, 'user', 'Enable to send booking notification message to your customers, after make a appointment.', 'enable-booking-con-title', ' Enable to send booking notification message to your customers, after make a appointment.'),
(889, 'user', 'Import Product/Service', 'import-productservice', 'Import Product/Service'),
(890, 'user', 'Import', 'import', 'Import'),
(891, 'user', 'Upload csv file', 'upload-csv-file', 'Upload csv file'),
(892, 'user', 'Upload', 'upload', 'Upload'),
(893, 'user', 'Download CSV Template', 'download-csv-template', 'Download CSV Template'),
(894, 'user', 'I agree with the', 'i-agree-with-the', 'I agree with the'),
(895, 'user', 'Import Products', 'import-products', 'Import Products'),
(896, 'user', 'Import Customers', 'import-customers', 'Import Customers'),
(897, 'user', 'SMALL BUSINESS ACCOUNTING SOFTWARE', 'small-business-accounting-software', 'SMALL BUSINESS ACCOUNTING SOFTWARE'),
(898, 'user', 'The features you need All in one place', 'home-feature-one-place', 'The <span class=\"text-primary\">features</span> you need <br>  All in one place'),
(899, 'user', 'Invoicing', 'invoicing', 'Invoicing'),
(900, 'user', 'Create professional invoices in minutes. Automatically add tracked time and expenses, calculate taxes, and customize your payment options.', 'invoicing-title', 'Create professional invoices in minutes. Automatically add tracked time and expenses, calculate taxes, and customize your payment options.'),
(901, 'user', 'Billing and <br>Payments', 'billing-and-payments', 'Billing and <br>Payments'),
(902, 'user', 'Bill fast, get paid even faster, and automate the rest with recurring invoices, online payments, and late payment reminders.', 'billing-and-payments-title', 'Bill fast, get paid even faster, and automate the rest with recurring invoices, online payments, and late payment reminders.'),
(903, 'user', 'Keep track of your expenses with mobile receipt scanning, bank account imports, and automated expense categorization.', 'expenses-title', 'Keep track of your expenses with mobile receipt scanning, bank account imports, and automated expense categorization.'),
...
(905, 'user', 'More Features', 'more-features', 'More Features');
...
INSERT INTO `products` (`id`, `user_id`, `business_id`, `quantity`, `unit`, `name`, `slug`, `price`, `details`, `is_sell`, `is_buy`, `income_category`, `expense_category`, `created_at`) VALUES
(1, 2, 18276373, 0, NULL, 'Pen', NULL, '20.00', NULL, 1, 0, 0, 0, NULL);
...
CREATE TABLE `settings` (
  ...
  `mercado_currency` varchar(255) DEFAULT NULL,
